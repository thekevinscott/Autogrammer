...
export const STRING_WITH_SINGLE_QUOTES = 'strsq';
export const STRING_WITH_DOUBLE_QUOTES = 'strdq';
...
export const ANY_VALID_STRING_VALUE_IN_QUOTES = 'anyvalidstringinquotes';
